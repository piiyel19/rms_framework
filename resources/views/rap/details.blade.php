                ...
                <div class="col-md-12">
                    ...
                    <table class="table">
                         <tr>
                            ...
                            <td colspan="5"><a href="<?= url('/')?>/bpa_details" style="color: #468ed5;"> test bpa </a></td>
                         </tr>
                         <tr>
                            <th class="left">Specific Event</th>
                            <td colspan="5"><a href="<?= url('/')?>/rr_details" style="color: #468ed5;"> test rr </a></td>
                         </tr>
                         <tr>
                         ...
                         <tr>
                            ...
                            <th class="left">
                              <b>Justification</b>
                              <i style="font-size:10px;">(Justification is required if Treatment Option
                              is Accept or Pass On or Terminate)</i>
                            </th>
                            <td colspan="2"></td>
                         </tr>
                         <tr>
                         ...
                         <tr>
                              <th class="left" colspan="6" style="background-color:#fff">
